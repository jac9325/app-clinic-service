...
@Component({
  selector: 'editar-examen-complementario',
  standalone: true,
  imports: [ CommonModule, NgbNavModule, FormsModule ],
  templateUrl: './editar-examen-complementario.component.html',
  styleUrl: './editar-examen-complementario.component.sass'
})
export class EditarExamenComplementarioComponent {
